#!/usr/bin/env node
/*
  ⚠️ 2026-08-26 起这个脚本**不在任何流程里**。

  它属于 R2 那条已经退役的图片工作流。图片搬进 src/content/posts/img/ 之后，
  压缩、各档缩略图、部署全部由 Astro 在构建时完成（见 docs/图片工作流.md）。

  留着不删，是因为哪天要恢复 R2 直传，这两个脚本还是对的。
  平时不用管它 —— 没有 npm script 指向它，构建也不碰它。
*/
/*
  给封面图生成列表用的小尺寸档位。
